...
<form  action="" id="mainForm" method="post">
    <div class="right">
        ...
        <div class="rightCont">
            <p class="g_title fix">内容列表 <a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:submitDeleteBatch();">删 除</a></p>
            <table class="tab1">
                ...
                <tr>
                    ...
                    <td width="85" align="right">
                        <input type="button"  onclick="javascript:submitQuery()" class="tabSub" value="查 询"/>
                ...
                <table class="tab2" width="100%">
                    ...
                    <c:forEach items="${messageList}" var="message" varStatus="status">
                        ...
                        <tr <c:if test="${status.index%2!=0}">style='background-color:#ECF6EE;'</c:if>>
                            ...
                            <td>
                                <a href="#">修改</a>&nbsp;&nbsp;&nbsp;
                                <a href="javascript:submitDeleteById(${message.id})" >删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
