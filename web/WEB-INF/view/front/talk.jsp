...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="<%= basePath %>static/js/jquery.mousewheel.js"></script>
	<!-- the jScrollPane script -->
	<script type="text/javascript" src="<%= basePath %>static/js/jquery.jscrollpane.min.js"></script>
	<script type="text/javascript" src="<%= basePath %>static/js/scroll-startstop.events.jquery.js"></script>
	<!--讨论区滚动条end-->
